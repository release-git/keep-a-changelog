...
mock({
  ...
  './CHANGELOG-VERSION_URL.md':
    '## [Unreleased]\n\n* Item A\n* Item B\n\n## [1.0.0] - 2020-05-02\n\n* Item C\n* Item D\n\n[unreleased]: https://github.com/release-git/release-git/compare/1.0.0..HEAD\n[1.0.0]: https://github.com/release-git/release-git/compare/0.0.0...1.0.0',
  './CHANGELOG-VERSION_URL_FORMATS.md':
    '## [Unreleased]\n\n* Item A\n* Item B\n\n## [1.0.0] - 2020-05-02\n\n* Item C\n* Item D\n\n[unreleased]: https://github.com/_git/release-git/release-git/compareBranch/1.0.0/HEAD\n[1.0.0]: https://github.com/_git/release-git/release-git/compareBranch/0.0.0/1.0.0',
  './CHANGELOG-VERSION_URL_HEAD.md':
    '## [Unreleased]\n\n* Item A\n* Item B\n\n## [1.0.0] - 2020-05-02\n\n* Item C\n* Item D\n\n[unreleased]: https://github.com/release-git/release-git/compare/1.0.0..main\n[1.0.0]: https://github.com/release-git/release-git/compare/0.0.0...1.0.0',
...
test('should add links to the end of the file', async t => {
  ...
  plugin.config.setContext({
    ...
    repo: {
      host: 'github.com',
      repository: 'release-git/release-git'
    }
  });
  await runTasks(plugin);
  assert.equal(plugin.getChangelog(), '* Item A\n* Item B');
  assert.match(
    ...
    /^## \[1\.0\.1] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/release-git\/release-git\/compare\/1\.0\.1\.\.\.HEAD\n\[1\.0\.1]: https:\/\/github\.com\/release-git\/release-git\/compare\/1\.0\.0\.\.\.1\.0\.1\n\[1\.0\.0]: https:\/\/github\.com\/release-git\/release-git\/compare\/0\.0\.0\.\.\.1\.0\.0\n$/
  );
});
...
test('should add links with custom URL formats to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[1\.0\.1] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/_git\/release-git\/release-git\/compareBranch\/1\.0\.1\/HEAD\n\[1\.0\.1]: https:\/\/github\.com\/_git\/release-git\/release-git\/compareBranch\/1\.0\.0\/1\.0\.1\n\[1\.0\.0]: https:\/\/github\.com\/_git\/release-git\/release-git\/compareBranch\/0\.0\.0\/1\.0\.0\n$/
  );
});
...
test('should add links with custom head to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[1\.0\.1] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/release-git\/release-git\/compare\/1\.0\.1\.\.\.main\n\[1\.0\.1]: https:\/\/github\.com\/release-git\/release-git\/compare\/1\.0\.0\.\.\.1\.0\.1\n\[1\.0\.0]: https:\/\/github\.com\/release-git\/release-git\/compare\/0\.0\.0\.\.\.1\.0\.0\n$/
  );
});
